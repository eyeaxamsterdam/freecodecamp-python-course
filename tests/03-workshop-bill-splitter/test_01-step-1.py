...
_step = os.path.join(os.path.dirname(__file__), '..', '..', 'steps', '03-workshop-bill-splitter', '01-step-1.py')
...
def test_hint_1():
    ...
    assert _Node(_code).has_variable('running_total')

def test_hint_2():
    """You should assign the integer 0 to your running_total variable."""
    assert _Node(_code).find_variable('running_total').is_equivalent('running_total = 0')
