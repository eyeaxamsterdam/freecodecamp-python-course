...
_step = os.path.join(os.path.dirname(__file__), '..', '..', 'steps', '04-workshop-movie-ticket-booking-calculator', '05-step-5.py')
...
def test_hint_1():
    ...
    assert _Node(_code).find_ifs()[1].find_conditions()[1].is_empty()
