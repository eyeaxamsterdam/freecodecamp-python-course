...
_step = os.path.join(os.path.dirname(__file__), '..', '..', 'steps', '01-workshop-report-card-printer', '05-step-5.py')
...
def test_hint_1():
    ...
    assert _Node(_code).has_call("print(is_student, type(is_student))")
